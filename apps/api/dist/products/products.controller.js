...
let ProductsController = class ProductsController {
    ...
    create(req, createProductDto) {
        return this.productsService.create({
            ...
            status: product_entity_1.ProductStatus.PENDING_REVIEW,
        });
    }
    findAll(status, search, category) {
        if (status === 'approved') {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "findPendingReview", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, admin_guard_1.AdminGuard),
    (0, common_1.Put)('admin/:id/approve'),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, admin_guard_1.AdminGuard),
    (0, common_1.Put)('admin/:id/reject'),
    __param(0, (0, common_1.Param)('id')),
